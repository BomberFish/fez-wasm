...
namespace FezGame.Components.Actions
{
	public class ClimbLadder : PlayerAction
	{
		...
		private bool TestLadderCollision(TrileInstance instance, bool onAxis)
		{
			...
			return actorSettings.Type == ActorType.Ladder && axis == base.CameraManager.Viewpoint.VisibleAxis() == onAxis;
		}
		...
		protected override bool Act(TimeSpan elapsed)
		{
			...
			float num = base.InputManager.Movement.Y * 4.7f * 0.425f * (float)elapsed.TotalSeconds;
			Vector3 upDownMovement = num * Vector3.UnitY;
			...
			float num2 = FezMath.Saturate(Math.Abs(base.PlayerManager.Animation.Timing.NormalizedStep * 2f % 1f - 0.5f)) * 1.4f + 0.25f;
