...
namespace FezGame.Components.Actions
{
	internal class EnterTunnel : PlayerAction
	{
		...
		{
			return base.PlayerManager.Action == ActionType.EnteringTunnel || base.PlayerManager.Action == ActionType.EnterTunnelCarry || base.PlayerManager.Action == ActionType.EnterTunnelCarryHeavy;
		}
	}
}
