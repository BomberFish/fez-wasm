	...
	public class Lift : PlayerAction
	{
		...
		protected override void TestConditions()
		{
			...
			case ActionType.IdleYawn:
			{
				...
				MultipleHits<CollisionResult> result = base.CollisionManager.CollideEdge(trileInstance.Center, trileInstance.Trile.Size.Y * Vector3.Up * Math.Sign(base.CollisionManager.GravityFactor), halfSize, Direction2D.Vertical);
		...
		private Vector3 GetDestination()
		{
			...
			Vector3 vector4 = pushedInstance.Center * vector2 + base.PlayerManager.Position * vector3;
			return vector4 * FezMath.XZMask + -pushedInstance.TransformedSize / 2f * vector + -0.4375f * vector + base.PlayerManager.Position * Vector3.UnitY;
		}
