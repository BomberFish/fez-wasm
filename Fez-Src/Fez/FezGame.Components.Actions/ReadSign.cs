...
namespace FezGame.Components.Actions
{
	public class ReadSign : PlayerAction
	{
		...
		{
			return TestSignCollision(VerticalDirection.Up) || TestSignCollision(VerticalDirection.Down);
		}
		...
		private bool TestSignCollision(VerticalDirection direction)
		{
			...
			bool flag = trile.ActorSettings.Type == ActorType.Sign && faceOrientation == base.CameraManager.VisibleOrientation && surface.ActorSettings != null && !string.IsNullOrEmpty(surface.ActorSettings.SignText);
			if (flag)
			{
