		...
		protected override void TestConditions()
		{
			...
			foreach (Volume currentVolume in base.PlayerManager.CurrentVolumes)
			{
				if (currentVolume.ActorSettings != null && currentVolume.ActorSettings.IsBlackHole)
				{
					...
					Vector3 vector2 = (currentVolume.From + currentVolume.To) / 2f;
					Vector3 vector3 = vector2 - vector / 2f * base.CameraManager.Viewpoint.ForwardVector();
					base.PlayerManager.Action = ActionType.SuckedIn;
					base.PlayerManager.Position = base.PlayerManager.Position * base.CameraManager.Viewpoint.ScreenSpaceMask() + vector3 * base.CameraManager.Viewpoint.DepthMask() + -0.25f * base.CameraManager.Viewpoint.ForwardVector();
