...
namespace FezGame.Components.Actions
{
	public class Throw : PlayerAction
	{
		...
		protected override void TestConditions()
		{
			...
			if (((uint)(actionType - 12) <= 3u || (uint)(actionType - 17) <= 3u) && !base.PlayerManager.Background && base.InputManager.GrabThrow == FezButtonState.Pressed && (base.InputManager.Down != FezButtonState.Down || FezMath.AlmostEqual(base.InputManager.Movement, Vector2.Zero, 0.5f)))
			{
