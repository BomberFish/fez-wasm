	...
	internal class Fractal : DrawableGameComponent
	{
		...
		public override void Update(GameTime gameTime)
		{
			...
			case State.RotateReveal:
			{
				...
				OuterShellMesh.Rotation = Quaternion.Slerp(Quaternion.Identity, Quaternion.CreateFromAxisAngle(Vector3.UnitY, MathF.PI), amount) * Quaternion.CreateFromRotationMatrix(Matrix.CreateLookAt(Vector3.One, Vector3.Zero, Vector3.Up));
			...
			case State.RainbowZoom:
			{
				...
				Quaternion quaternion3 = (OuterShellMesh.Rotation = (OuterShellMesh.Rotation = Quaternion.CreateFromAxisAngle(Vector3.UnitZ, num6 * 0.02f) * OuterShellMesh.Rotation));
