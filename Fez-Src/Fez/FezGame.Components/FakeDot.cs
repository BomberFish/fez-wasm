...
namespace FezGame.Components
{
	public class FakeDot : DrawableGameComponent
	{
		...
		public override void Update(GameTime gameTime)
		{
			...
			DotMesh.Rotation = Quaternion.CreateFromAxisAngle(Vector3.Right, (float)Math.Asin(Math.Sqrt(2.0) / Math.Sqrt(3.0))) * Quaternion.CreateFromAxisAngle(Vector3.Up, MathF.PI / 4f);
		...
		private void UpdateRays(float elapsedSeconds)
		{
			...
			Quaternion quaternion2 = (FlareMesh.Rotation = (RaysMesh.Rotation = Quaternion.Identity));
		...
		public override void Draw(GameTime gameTime)
		{
			...
			Matrix? matrix5 = (effect.ForcedProjectionMatrix = (effect2.ForcedProjectionMatrix = matrix2));
			FlareMesh.Draw();
			RaysMesh.Draw();
