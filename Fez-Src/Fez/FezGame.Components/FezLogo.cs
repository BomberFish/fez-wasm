...
namespace FezGame.Components
{
	public class FezLogo : DrawableGameComponent
	{
		...
		public override void Initialize()
		{
			...
			Group group = WireMesh.AddGroup();
			IndexedUserPrimitives<FezVertexPositionColor> indexedUserPrimitives = (IndexedUserPrimitives<FezVertexPositionColor>)(group.Geometry = new IndexedUserPrimitives<FezVertexPositionColor>(PrimitiveType.LineList));
			...
			group = WireMesh.AddGroup();
			indexedUserPrimitives = (IndexedUserPrimitives<FezVertexPositionColor>)(group.Geometry = new IndexedUserPrimitives<FezVertexPositionColor>(PrimitiveType.LineList));
			...
			Vector3 vector3 = (WireMesh.Position = (LogoMesh.Position = new Vector3(-5.5f, -2f, -0.5f)));
			WireMesh.BakeTransform<FezVertexPositionColor>();
			LogoMesh.BakeTransform<FezVertexPositionColor>();
			DrawActionScheduler.Schedule(delegate
			{
				BaseEffect baseEffect3 = (WireMesh.Effect = (LogoMesh.Effect = (FezEffect = new DefaultEffect.VertexColored())));
			});
		...
		public override void Update(GameTime gameTime)
		{
			...
			Vector3 vector3 = (WireMesh.Position = (LogoMesh.Position = new Vector3(0f, 0f - num, 0f)));
			if (FezEffect != null)
			{
		...
		private void DoDraw()
		{
			if (!IsDisposed)
			{
				...
				if (forFrames == 0)
				{
					...
					Vector3 vector3 = (WireMesh.Scale = (LogoMesh.Scale = new Vector3(1f, 1f, 1f)));
