	...
	internal class FinalRebuildHost : DrawableGameComponent
	{
		...
		private void TryInitialize()
		{
			...
			if (base.Enabled)
			{
				...
				Quaternion quaternion = (OriginalCubeRotation = (SolidCubes.Rotation = WhiteCube.Rotation));
		...
		public override void Update(GameTime gameTime)
		{
			...
			case Phases.SpinFill:
			{
				...
				Vector3 vector3 = (SolidCubes.Position = (WhiteCube.Position = PlayerManager.Position + new Vector3(0f, 6f, 0f)));
				Quaternion quaternion5 = (SolidCubes.Rotation = (WhiteCube.Rotation = Quaternion.CreateFromAxisAngle(Vector3.UnitY, num3 * (MathF.PI * 2f) * 3f) * OriginalCubeRotation));
			...
			case Phases.MotorStart1:
			{
				...
				Quaternion quaternion2 = (HexahedronAo.Rotation = Quaternion.CreateFromAxisAngle(Vector3.UnitY, num8 * (MathF.PI * 2f) * 4f) * OriginalCubeRotation);
				Quaternion quaternion5 = (solidCubes3.Rotation = (whiteCube3.Rotation = quaternion2));
				if (PhaseTime > 5f)
				{
			...
			case Phases.MotorStart2:
			{
				...
				Quaternion quaternion2 = (HexahedronAo.Rotation = Quaternion.CreateFromAxisAngle(Vector3.UnitY, num9 * (MathF.PI * 2f) * 5f) * OriginalCubeRotation);
				Quaternion quaternion5 = (solidCubes4.Rotation = (whiteCube4.Rotation = quaternion2));
			...
			case Phases.MotorStart3:
			{
				...
				Quaternion quaternion2 = (HexahedronAo.Rotation = Quaternion.CreateFromAxisAngle(Vector3.UnitY, num * (MathF.PI * 2f) * 20f) * OriginalCubeRotation);
				Quaternion quaternion5 = (solidCubes.Rotation = (whiteCube.Rotation = quaternion2));
				if (PhaseTime > 8f)
				{
					ChangePhase();
				}
			...
			case Phases.SmoothStart:
			{
				...
				Quaternion quaternion2 = (HexahedronAo.Rotation = Quaternion.CreateFromAxisAngle(Vector3.UnitY, num7 * (MathF.PI * 2f) * 18f) * OriginalCubeRotation);
				Quaternion quaternion5 = (solidCubes2.Rotation = (whiteCube2.Rotation = quaternion2));
				if (PhaseTime > 10f)
				{
		...
		private void UpdateRays(float elapsedSeconds)
		{
			...
			Vector3 vector2 = (FlareMesh.Position = (RaysMesh.Position = HexahedronAo.Position));
