	...
	internal class HeavyGroupState
	{
		...
		public void Update(TimeSpan elapsed)
		{
			if (!moving)
			{
				...
				bool flag = false;
				TrileInstance[] array = bottomTriles;
			...
			TrileInstance[] array2 = bottomTriles;
			foreach (TrileInstance trileInstance2 in array2)
			{
				MultipleHits<CollisionResult> multipleHits = CollisionManager.CollideEdge(trileInstance2.Center, trileInstance2.PhysicsState.Velocity + vector, trileInstance2.TransformedSize / 2f, Direction2D.Vertical);
