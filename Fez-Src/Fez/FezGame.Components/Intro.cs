...
namespace FezGame.Components
{
	public class Intro : DrawableGameComponent
	{
		...
		protected override void LoadContent()
		{
			...
			Logger.Log("Intro", "Past DrawActionScheduler.Schedule");
			tr = new GlyphTextRenderer(base.Game);
			Logger.Log("Intro", "Past GlyphTextRenderer");
			...
			Logger.Log("Intro", "Past TrialMesh");
			DrawActionScheduler.Schedule(delegate
			{
			...
			Logger.Log("Intro", "Past FirstBootComplete");
