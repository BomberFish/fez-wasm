...
namespace FezGame.Components
{
	public class LetterViewer : DrawableGameComponent
	{
		...
		public override void Draw(GameTime gameTime)
		{
			...
			float num6 = (float)base.GraphicsDevice.Viewport.Width / (1280f * viewScale);
			float num7 = (float)base.GraphicsDevice.Viewport.Height / (720f * viewScale);
			Matrix textureMatrix = new Matrix(1f, 0f, 0f, 0f, 0f, 1f, 0f, 0f, -0.5f, -0.5f, 1f, 0f, 0f, 0f, 0f, 0f) * new Matrix(num2 / num4 / 4f / viewScale, 0f, 0f, 0f, 0f, num3 / num5 / 4f / viewScale, 0f, 0f, 0f, 0f, 1f, 0f, 0f, 0f, 0f, 1f) * new Matrix(1f, 0f, 0f, 0f, 0f, 1f, 0f, 0f, 0.85f, 0.1f + 0.4f * num7, 1f, 0f, 0f, 0f, 0f, 0f);
			...
			float num8 = (Culture.IsCJK ? (FontManager.SmallFactor + 0.05f) : FontManager.BigFactor);
			num8 *= viewScale;
			string letterText = LetterText;
			int num9 = (Culture.IsCJK ? 500 : 135);
			letterText = WordWrap.Split(letterText, spriteFont, num9);
			...
			float num10 = 176f * viewScale;
			Vector3 vector = TextColor.ToVector3();
			textRenderer.DrawString(sb, spriteFont, text, new Vector2(x, num10 * num7 + num8 * FontManager.TopSpacing), new Color(vector.X, vector.Y, vector.Z, num), num8);
			if (!Culture.IsCJK)
			{
			...
			textRenderer.DrawShadowedText(sb, FontManager.Big, StaticText.GetString("AchievementInTrialResume"), new Vector2(x, num7 * 115f * viewScale + FontManager.TopSpacing * num8), new Color(0.5f, 1f, 0.5f, alpha), FontManager.BigFactor * viewScale);
			sb.End();
		}
