...
namespace FezGame.Components
{
	internal class NesGlitches : DrawableGameComponent
	{
		...
		public override void Initialize()
		{
			...
			Group group = GlitchMesh.AddGroup();
			group.Geometry = (Geometry = new ShaderInstancedIndexedPrimitives<VertexPositionTextureInstance, Matrix>(PrimitiveType.TriangleList, 60));
