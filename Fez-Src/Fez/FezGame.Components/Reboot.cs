	...
	public class Reboot : DrawableGameComponent
	{
		...
		public override void Draw(GameTime gameTime)
		{
			...
			if (SinceCreated.TotalSeconds > 3.0)
			{
				...
				float num3 = 1280f;
				float num4 = 720f;
				float num5 = BootTexture.Width;
				float num6 = BootTexture.Height;
				Matrix textureMatrix = new Matrix(1f, 0f, 0f, 0f, 0f, 1f, 0f, 0f, -0.5f, -0.5f, 1f, 0f, 0f, 0f, 0f, 0f) * new Matrix(num3 / num5 / 2f / num2, 0f, 0f, 0f, 0f, num4 / num6 / 2f / num2, 0f, 0f, 0f, 0f, 1f, 0f, 0f, 0f, 0f, 1f) * new Matrix(1f, 0f, 0f, 0f, 0f, 1f, 0f, 0f, 0.56f, 0.5f, 1f, 0f, 0f, 0f, 0f, 0f);
				TargetRenderer.DrawFullscreen(BootTexture, textureMatrix);
				float num7 = num / 4f;
				float num8 = ((num7 < 0.2f) ? 0.22f : ((num7 < 0.4f) ? 0.293f : ((num7 < 0.6f) ? 0.361f : ((num7 < 0.7f) ? 0.528f : ((num7 < 0.8f) ? 0.7f : 1f)))));
				effect.PseudoWorld = new Matrix(1f, 0f, 0f, 0f, 0f, 1f, 0f, 0f, 0f, 0f, 1f, 0f, 0f, (0f - num8) * 2f, 0f, 1f);
				TargetRenderer.DrawFullscreen(effect, Color.Black);
				if (num > 1f)
				{
					num5 = LaserCheckTexture.Width;
					num6 = LaserCheckTexture.Height;
					textureMatrix = new Matrix(1f, 0f, 0f, 0f, 0f, 1f, 0f, 0f, -0.5f, -0.5f, 1f, 0f, 0f, 0f, 0f, 0f) * new Matrix(num3 / num5 / 2f / num2, 0f, 0f, 0f, 0f, num4 / num6 / 2f / num2, 0f, 0f, 0f, 0f, 1f, 0f, 0f, 0f, 0f, 1f) * new Matrix(1f, 0f, 0f, 0f, 0f, 1f, 0f, 0f, -1.15f, 1f, 1f, 0f, 0f, 0f, 0f, 0f);
