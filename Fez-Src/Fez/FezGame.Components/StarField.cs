...
namespace FezGame.Components
{
	public class StarField : DrawableGameComponent
	{
		...
		private void AddStars()
		{
			...
			Group group2;
			AddPoints(group2 = StarsMesh.AddGroup(), array3, texture, 2f);
			StarGeometry = group2.Geometry;
			if (HasHorizontalTrails)
			{
				group2 = TrailsMesh.AddLines(array, array2, buffered: true);
			}
		}
		...
		public void Draw()
		{
			...
			else if (!GameState.InFpsMode)
			{
				...
				if (HasHorizontalTrails)
				{
					...
					Vector3 vector3 = (TrailsMesh.Scale = (StarsMesh.Scale = new Vector3(65f / (CameraManager.Radius / viewScale / num + 25f))));
				}
			}
