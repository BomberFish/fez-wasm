...
namespace FezGame.Services.Scripting
{
	public class GomezService : IGomezService, IScriptingBase
	{
		...
		public bool Alive => PlayerManager.Action != ActionType.Dying && PlayerManager.Action != ActionType.FreeFalling && PlayerManager.Action != ActionType.SuckedIn && PlayerManager.Action != ActionType.Sinking;
