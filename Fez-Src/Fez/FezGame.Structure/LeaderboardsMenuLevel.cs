...
namespace FezGame.Structure
{
	internal class LeaderboardsMenuLevel : MenuLevel
	{
		...
		private LeaderboardView view = LeaderboardView.Friends;
		...
		{
			// base.Reset();
			// base.XButtonString = "{X} " + string.Format(StaticText.GetString("CurrentLeaderboardView"), StaticText.GetString(view.ToString() + "LeaderboardView"));
		}
