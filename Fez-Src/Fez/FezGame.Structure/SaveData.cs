...
namespace FezGame.Structure
{
	public class SaveData
	{
		...
		public bool HasNewGamePlus => Finished32 || Finished64;
		...
		public LevelSaveData ThisLevel
		{
			...
			{
				LevelSaveData value;
				return (Level == null || !World.TryGetValue(Level, out value)) ? LevelSaveData.Default : value;
			}
		}
		...
		public void Clear()
		{
			...
			if (Fez.ForceGoldenCubes != 0 || Fez.ForceAntiCubes != 0)
			{
				...
				{
					CubeShards = Fez.ForceGoldenCubes;
				}
				if (Fez.ForceAntiCubes != 0)
				{
					SecretCubes = Fez.ForceAntiCubes;
				}
			}
		}
