...
namespace FezGame.Tools
{
	public struct LocalizedKeyboardState
	{
		...
		{
			uint key2 = MapVirtualKeyEx((uint)key, MAPVK.VK_TO_VSC, KeyboardLayout.US_English.Handle);
			return (Keys)MapVirtualKeyEx(key2, MAPVK.VSC_TO_VK, KeyboardLayout.Active.Handle);
		}
	}
}
