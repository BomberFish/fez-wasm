...
namespace FezGame
{
	public class Fez : Game
	{
		...
		public static bool SpeedRunBugs;
		...
		public static string Version = "1.13 (beta) (WASM)";
		...
		protected override void Initialize()
		{
			...
			ServiceHelper.AddComponent(soundManager = new SoundManager(this, NoMusic), addServices: true);
			...
			{
				Logger.Log("Fez", "Loading intro");
				ServiceHelper.AddComponent(new Intro(this));
				Logger.Log("Fez", "Done loading intro");
				base.Initialize();
				Logger.Log("Fez", "Initialized");
			}
		}
