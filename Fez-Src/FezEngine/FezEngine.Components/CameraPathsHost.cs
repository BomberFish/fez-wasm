		...
		private class CameraPathState
		{
			...
			public void Update(TimeSpan elapsed)
			{
				...
				if (Path.IsSpline)
				{
					...
					PathSegment pathSegment3 = Nodes[Math.Min(nodeIndex + 1, Nodes.Count - 1)];
					center = Vector3.CatmullRom(pathSegment2.Destination, pathSegment.Destination, currentNode.Destination, pathSegment3.Destination, amount);
