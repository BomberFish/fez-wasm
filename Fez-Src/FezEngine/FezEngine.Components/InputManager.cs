	...
	public class InputManager : GameComponent, IInputManager
	{
		...
		public override void Update(GameTime gameTime)
		{
			...
			if (keyboard)
			{
				...
				FezButtonState fezButtonState2 = (ExactUp = (Up = KeyboardState.Up));
		...
		public void Reset()
		{
			...
			FezButtonState fezButtonState9 = (Up = (Down = fezButtonState6));
			Vector2 vector3 = (Movement = (FreeLook = default(Vector2)));
			fezButtonState6 = (Jump = FezButtonState.Up);
			fezButtonState9 = (CancelTalk = (GrabThrow = fezButtonState6));
			fezButtonState9 = (Start = (Back = FezButtonState.Up));
			fezButtonState9 = (RotateLeft = (RotateRight = FezButtonState.Up));
			OpenInventory = FezButtonState.Up;
			fezButtonState9 = (ClampLook = (FpsToggle = FezButtonState.Up));
			fezButtonState9 = (MapZoomIn = (MapZoomOut = FezButtonState.Up));
		}
		...
		{
			return GrabThrow == FezButtonState.Pressed || Jump == FezButtonState.Pressed || OpenInventory == FezButtonState.Pressed || Start == FezButtonState.Pressed || CancelTalk == FezButtonState.Pressed;
		}
	}
}
