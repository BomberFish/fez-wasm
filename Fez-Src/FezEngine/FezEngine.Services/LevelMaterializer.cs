...
namespace FezEngine.Services
{
	public class LevelMaterializer : GameComponent, ILevelMaterializer
	{
		...
		private TrileUpdateAction lastUpdateAction = TrileUpdateAction.None;
		...
		public virtual RenderPass RenderPass
		{
			...
			set
			{
				...
				case RenderPass.LightInAlphaEmitters:
				{
					...
					LightingEffectPass lightingEffectPass9 = (ArtObjectsEffect.Pass = LightingEffectPass.Pre);
					LightingEffectPass lightingEffectPass11 = (trilesEffect.Pass = lightingEffectPass9);
					LightingEffectPass lightingEffectPass2 = (animatedPlanesEffect3.Pass = lightingEffectPass11);
					LightingEffectPass lightingEffectPass5 = (npcEffect2.Pass = (staticPlanesEffect.Pass = lightingEffectPass2));
				...
				{
					LightingEffectPass lightingEffectPass5 = (AnimatedPlanesEffect.Pass = (StaticPlanesEffect.Pass = LightingEffectPass.Main));
					InstancedAnimatedPlaneEffect animatedPlanesEffect2 = AnimatedPlanesEffect;
					bool ignoreFog = (StaticPlanesEffect.IgnoreFog = true);
					animatedPlanesEffect2.IgnoreFog = ignoreFog;
				...
				case RenderPass.Normal:
				{
					...
					LightingEffectPass lightingEffectPass5 = (npcEffect.Pass = (artObjectsEffect.Pass = lightingEffectPass2));
		...
		public void DestroyMaterializers(TrileSet trileSet)
		{
			if (trileSet != null)
			{
				...
				TrileMaterializer[] array2 = array;
				foreach (TrileMaterializer trileMaterializer in array2)
				{
		...
		public void RemoveInstance(TrileInstance instance)
		{
			if (instance.TrileId == -1 || LevelManager.TrileSet == null || !LevelManager.TrileSet.Triles.ContainsKey(instance.TrileId))
			{
				bool flag = fallbackMaterializer.Trile.Instances.Remove(instance);
			}
			else
			{
				bool flag = instance.VisualTrile.Instances.Remove(instance);
			}
		}
		...
		{
			if (action == TrileUpdateAction.None)
			{
				return;
			}
			switch (action)
