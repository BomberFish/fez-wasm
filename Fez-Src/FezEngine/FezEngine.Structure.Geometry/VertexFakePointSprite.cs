...
namespace FezEngine.Structure.Geometry
{
	...
	public struct VertexFakePointSprite : IEquatable<VertexFakePointSprite>, IColoredVertex, IVertex, IVertexType, ITexturedVertex
	{
		...
		{
			return other.Position == Position && other.Color == Color && other.TextureCoordinate == TextureCoordinate && other.Offset == Offset;
		}
		...
		{
			return obj != null && Equals((VertexFakePointSprite)obj);
		}
	}
}
