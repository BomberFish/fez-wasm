...
namespace FezEngine.Structure.Geometry
{
	...
	public struct VertexPositionColorTextureInstance : IEquatable<VertexPositionColorTextureInstance>, IShaderInstantiatableVertex, ITexturedVertex, IVertex, IVertexType, IColoredVertex
	{
		...
		{
			return other.Position == Position && other.Color == Color && other.TextureCoordinate == TextureCoordinate && other.InstanceIndex == InstanceIndex;
		}
		...
		{
			return obj != null && Equals((VertexPositionColorTextureInstance)obj);
		}
	}
}
