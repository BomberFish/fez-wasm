...
namespace FezEngine.Structure.Geometry
{
	...
	public struct VertexPositionTextureInstance : IEquatable<VertexPositionTextureInstance>, IShaderInstantiatableVertex, ITexturedVertex, IVertex, IVertexType
	{
		...
		{
			return other.Position == Position && other.TextureCoordinate == TextureCoordinate && other.InstanceIndex == InstanceIndex;
		}
		...
		{
			return obj != null && Equals((VertexPositionTextureInstance)obj);
		}
	}
}
