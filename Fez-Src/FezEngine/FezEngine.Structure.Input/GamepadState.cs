	...
	public class GamepadState
	{
		...
		private struct VibrationMotorState
		{
			...
			public VibrationMotorState(double maximumAmount, TimeSpan duration, EasingType easingType)
			{
				...
				Active = true;
				float num3 = (LastAmount = (CurrentAmount = 0f));
		...
		private static void UpdateLayout()
		{
			...
			if (gUIDEXT.Equals("4c05e60c") || gUIDEXT.Equals("4c05c405") || gUIDEXT.Equals("4c05cc09") || gUIDEXT.Equals("4c05a00b"))
			{
		...
		private static VibrationMotorState UpdateMotor(VibrationMotorState motorState, TimeSpan elapsedTime)
		{
			...
			{
				double totalSeconds = motorState.ElapsedTime.TotalSeconds;
				TimeSpan duration = motorState.Duration;
				float num = Easing.EaseIn(1.0 - totalSeconds / duration.TotalSeconds, motorState.EasingType);
