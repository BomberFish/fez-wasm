...
namespace FezEngine.Structure.Scripting
{
	public static class EntityTypes
	{
		...
		{
			return (!(info.GetCustomAttributes(typeof(DescriptionAttribute), inherit: false).FirstOrDefault() is DescriptionAttribute descriptionAttribute)) ? null : descriptionAttribute.Description;
		}
