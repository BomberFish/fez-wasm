...
namespace FezEngine.Structure
{
	public class PathSegment
	{
		...
		public PathSegment Clone()
		{
			...
			pathSegment.Acceleration = Acceleration;
			pathSegment.Deceleration = Deceleration;
			pathSegment.Destination = Destination;
			pathSegment.Duration = Duration;
			pathSegment.JitterFactor = JitterFactor;
			pathSegment.WaitTimeOnFinish = WaitTimeOnFinish;
			pathSegment.WaitTimeOnStart = WaitTimeOnStart;
			pathSegment.Orientation = Orientation;
			pathSegment.CustomData = ((CustomData == null) ? null : (CustomData.Clone() as ICloneable));
			return pathSegment;
		}
	}
}
