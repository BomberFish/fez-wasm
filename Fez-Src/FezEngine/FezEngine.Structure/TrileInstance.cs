...
namespace FezEngine.Structure
{
	public class TrileInstance
	{
		...
		public bool Overlaps => OverlappedTriles != null && OverlappedTriles.Count > 0;
		...
		static TrileInstance()
		{
			...
			{
				FezMath.QuaternionFromPhi(-MathF.PI),
				FezMath.QuaternionFromPhi(-MathF.PI / 2f),
		...
		{
			data.PositionPhi.W = (float)(orientation - 2) * (MathF.PI / 2f);
