...
namespace FezEngine.Structure
{
	...
	public struct TrixelEmplacement : IEquatable<TrixelEmplacement>, IComparable<TrixelEmplacement>
	{
		...
		{
			return obj is TrixelEmplacement && Equals((TrixelEmplacement)obj);
		}
		...
		{
			return Math.Abs(X - other.X) == 1 || Math.Abs(Y - other.Y) == 1 || Math.Abs(Z - other.Z) == 1;
		}

		public bool Equals(TrixelEmplacement other)
		{
			return (object)other != null && other.X == X && other.Y == Y && other.Z == Z;
		}
