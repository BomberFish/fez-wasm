...
namespace FezEngine.Tools
{
	public static class Easing
	{
		...
		{
			return (linearStep < 0.5) ? MathHelper.Lerp((float)linearStep, EaseInOut(linearStep, easeInType), acceleration) : MathHelper.Lerp((float)linearStep, EaseInOut(linearStep, easeOutType), deceleration);
		}
