...
namespace FezEngine.Tools
{
	public static class FezMath
	{
		...
		{
			float value = 1f - (float)Math.Pow(Math.Pow(0f - oldFactor + 1f, 58.8235294117647), dt);
		...
		{
			return In(value, value1, value2, value3, value4, value5, value6, comparer) || comparer.Equals(value, value7);
		}
		...
		{
			return In(value, value1, value2, value3, value4, value5, value6, value7, comparer) || comparer.Equals(value, value8);
		}
		...
		{
			return In(value, value1, value2, value3, value4, value5, value6) || value.Equals(value7);
		}
		...
		{
			return In(value, value1, value2, value3, value4, value5, value6, value7) || value.Equals(value8);
		}
		...
		{
			return AlmostWrapEqual(a.X, b.X, epsilon) && AlmostWrapEqual(a.Y, b.Y, epsilon);
		}
		...
		{
			return orientation != FaceOrientation.Down && orientation != FaceOrientation.Top;
		}
		...
		public static float ToPhi(this FaceOrientation orientation)
		{
			return orientation switch
			{
				...
				FaceOrientation.Right => MathF.PI / 2f, 
				FaceOrientation.Back => -MathF.PI, 
				FaceOrientation.Left => -MathF.PI / 2f, 
		...
		public static float ToPhi(this Viewpoint view)
		{
			...
			{
				Viewpoint.Front => 0f, 
				Viewpoint.Right => MathF.PI / 2f, 
				Viewpoint.Back => -MathF.PI, 
				Viewpoint.Left => -MathF.PI / 2f, 
		...
		public static FaceOrientation OrientationFromPhi(float phi)
		{
			...
			if (AlmostEqual(phi, MathF.PI / 2f))
			{
				return FaceOrientation.Right;
			}
			if (AlmostEqual(phi, -MathF.PI))
			{
		...
		{
			theta = ((!(theta >= -MathF.PI)) ? ((theta - MathF.PI) % (MathF.PI * 2f) + MathF.PI) : ((theta + MathF.PI) % (MathF.PI * 2f) - MathF.PI));
			return theta;
		}
		...
		{
			if ((combinedPhi > MathF.PI / 4f && combinedPhi < MathF.PI * 3f / 4f) || (combinedPhi < -MathF.PI / 4f && combinedPhi > MathF.PI * -3f / 4f))
			{
				return Axis.X;
			}
			return Axis.Z;
